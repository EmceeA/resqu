...
namespace Resqu.Core.Migrations
{
    ...
    [Migration("20210629132726_added relationship to issue model")]
    partial class addedrelationshiptoissuemodel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Resqu.Core.Entities.CustomerRequestService", b =>
                {
                    ...
                    b.ToTable("CustomerRequestServices");
                });
            ...
            modelBuilder.Entity("Resqu.Core.Entities.Expertise", b =>
                {
                    ...
                    b.Property<int>("VendorSpecializationId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Resqu.Core.Entities.ProductVendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Resqu.Core.Entities.ServiceToSericeCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ServiceToSericeCategorys");
                });

            modelBuilder.Entity("Resqu.Core.Entities.ServiceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Resqu.Core.Entities.VendorProcessService", b =>
                {
                    ...
                    b.ToTable("VendorProcessServices");
                });

            modelBuilder.Entity("Resqu.Core.Entities.VendorProcessServiceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("VendorProcessServiceTypes");
                });
            ...
            modelBuilder.Entity("Resqu.Core.Entities.VendorSpecialization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
